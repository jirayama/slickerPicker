	...
	function draw_colorPicker(h) {
      ...
      for (y = 0; y <= 130; y++) {
        for (x = 0; x <= 200; x++) {
          ...
          // } else if(s>25 && s<26){
          // 	colorPicker_ctx.fillStyle = "#f1ff5a";
          // } else if(s>50 && s<51){
          // 	colorPicker_ctx.fillStyle = "#c3d505";
          // } else if(s>75 && s<76){
          // 	colorPicker_ctx.fillStyle = "#95a300";
          // }
          colorPicker_ctx.fillRect(x, y, 1, 1);
          s = Math.linearTween(x, startS, 100, 200);
          l = Math.linearTween(x, startL, -(startL - endL), 200);
        }
        endL = Math.linearTween(y, 50, -50, 130);
